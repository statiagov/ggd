...
namespace :ffcrm do
  namespace :config do
    ...
    task :copy_database_yml do
      ...
      orig, dest = StatiaGov.root.join(filename), Rails.root.join('config/database.yml')
    ...
    # Soon, statia_gov should also make the move, which involves adjustments to yml files.
